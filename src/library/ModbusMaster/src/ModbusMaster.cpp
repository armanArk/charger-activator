...
uint8_t ModbusMaster::calibrationTurnOn()
{
  return ModbusMasterTransaction(ku8MBCalibrationTurnOn);
}
uint8_t ModbusMaster::calibrationStartZero()
{
  return ModbusMasterTransaction(ku8MBCalibrationStartZeroPoint);
}
uint8_t ModbusMaster::calibrationStartStandart()
{
  return ModbusMasterTransaction(ku8MBCalibrationStartStandart);
}
uint8_t ModbusMaster::calibrationTerminate()
{
  return ModbusMasterTransaction(ku8MBCalibrationTerminate);
}
/**
...
/*
 * ku8MBReadFBS_DEVICE_IDentifiers      = 0x2B/0E
 */
// uint8_t  ModbusMaster::readFBS_DEVICE_IDentifiers(uint8_t ObjectId)
uint8_t ModbusMaster::readFBS_DEVICE_IDentifiers(uint8_t ReadId, uint8_t ObjectId, char *pu8ReadStrBuffer, uint8_t u8ReadStrBufferMaxSize, uint8_t *pu8ReadStrSize)
{
  ...
  return ModbusMasterTransaction(ku8MBReadFBS_DEVICE_IDentifiers);
}
...
uint8_t ModbusMaster::ModbusMasterTransaction(uint8_t u8MBFunction)
{
  ...
  case ku8MBReadWriteMultipleRegisters:
    ...
    break;
  case ku8MBReadFBS_DEVICE_IDentifiers:
    // u8ModbusADUSize = 0;
    // u8ModbusADU[u8ModbusADUSize++] = u8MBFunction;
  ...
  while (u8BytesLeft && !u8MBStatus)
  {
    ...
    if ((u8ModbusADUSize == 5) && (u8ModbusADU[1] != ku8MBReadFBS_DEVICE_IDentifiers))
    {
    ...
    if (u8ModbusADU[1] == ku8MBReadFBS_DEVICE_IDentifiers) // function 2B-0E
    {
  ...
  if (u8ModbusADU[1] == ku8MBReadFBS_DEVICE_IDentifiers)
  {

...
public:
  ...
  */
  ...
  // uint8_t  readFBS_DEVICE_IDentifiers(uint8_t ReadId, uint8_t ObjectId);
  uint8_t readFBS_DEVICE_IDentifiers(uint8_t ReadId, uint8_t ObjectId, char *pu8ReadStrBuffer, uint8_t u8ReadStrBufferMaxSize, uint8_t *pu8ReadStrSize);
  uint8_t calibrationTurnOn();
  uint8_t calibrationStartZero();
  uint8_t calibrationStartStandart();
  uint8_t calibrationTerminate();
...
private:
  ...
  static const uint8_t ku8MBReadFBS_DEVICE_IDentifiers = 0x2B; ///< Modbus function 0x2B/0E Read FBS_DEVICE_IDentifiers

  static const uint8_t ku8MBCalibrationTurnOn = 0x1A;
  static const uint8_t ku8MBCalibrationStartZeroPoint = 0x1B;
  static const uint8_t ku8MBCalibrationStartStandart = 0x1C;
  static const uint8_t ku8MBCalibrationTerminate = 0x1D;
